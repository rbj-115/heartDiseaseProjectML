...
# Since 10% is 1/7 of the remaining 70%, use test_size=1/7
...
# Extra safety: ensure no bool columns remain in exported sheets
...
# Optional: also save full scaled dataset for inspection
...
# Extra safety for full export too
